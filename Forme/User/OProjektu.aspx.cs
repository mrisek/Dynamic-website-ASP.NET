...
public partial class OProjektu : System.Web.UI.Page
{
    ...
    //protected void OtvaranjePDFIzvjestaja(string put)
    //{
    //    string staza = Path.Combine(Server.MapPath(""), Path.GetFileName(put));
    //    try
    //    {
    //        if (File.Exists(put))
    //        {
    //            Response.Redirect("~/PDFs",false);
    //            Context.ApplicationInstance.CompleteRequest();
    //        }
    //    }
    //    catch (Exception ex)
